...
namespace DesignerWorkbench
{
    ...
    using Zell.CognitiveServices.Activities.Design;
    using Zell.MachineLearningModels;
    using Zell.MLModels.Activities.Design;
    ...
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        internal MainViewModel()
        {
            ...
            ZellCognitiveServicesMetadata.RegisterAll();
            ZellMLModelDesignerMetadata.RegisterAll();
        ...
        private static ToolboxControl CreateToolbox()
        {
            ...
            toolboxControl.Categories.Add(
                new ToolboxCategory("ZellCognitiveLibrary") { new ToolboxItemWrapper(typeof(TextTranslator)),
                                                              new ToolboxItemWrapper(typeof(DocumentTranslator)),
                                                              new ToolboxItemWrapper(typeof(TextModerator)) });
            toolboxControl.Categories.Add(
                new ToolboxCategory("ZellMLModelLibrary") { new ToolboxItemWrapper(typeof(EmailTicketClassifier)),
                                                            new ToolboxItemWrapper(typeof(CreditGrantAssessor)) });
